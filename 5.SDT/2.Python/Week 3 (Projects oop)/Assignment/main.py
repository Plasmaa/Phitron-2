class Restaurant:
    def __init__(self, name):
        self.name = name
        self.menu = {}  # Stores menu items: {item_name: price}
        self.customers = {}  # Stores customer objects: {email: Customer}
...
class Customer:
    ...
    def view_past_orders(self):
        ...
        if self.order_history:
            for idx, (item, price) in enumerate(self.order_history, start=1):
